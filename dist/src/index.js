    ...
    inquirer
        ...
        async function copyFiles() {
            ...
            try {
                ...
                if (answer.scss_structure == "clean") {
                    ...
                    folders.forEach(function (item) {
                        ...
                        fs.readFile(`${answer.scss_path}/scss/main.scss`, "utf8", function (err, data) {
                            ...
                            const searchKeywords = Object.values(answer.folder);
                            const keywordToRegex = new RegExp(searchKeywords.join("|"), "i");
                            const keywordToRegex2 = [keywordToRegex];
                            const result = dataArray.filter(function (dataItem) {
                ...
                console.log("\x1b[37m", `\n 🌎 Website:`, "\x1b[36m", `https://createscss.com`, "\x1b[37m", `\n ⭐️ Github:`, "\x1b[36m", ` https://github.com/maximedaraize/create-scss-cli-zzz`);
                return true;
            }
            catch (error) {
